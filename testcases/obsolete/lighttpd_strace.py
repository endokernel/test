...
resfilename = "../" + variable.resdir + "/lighttpd_ptrace.csv"
fp = open(resfilename + ".tmp", "wb")
for size in datasizes:
    fp.write(size.encode())
    fp.write(b',')
fp.write(b'\n')
servercmd = "strace -f ../bin/nocet/lighttpd -f ../conf/lighttpd_https.conf -m ../libs/nocet/lighttpd_mod/ -D 2> /dev/null"
